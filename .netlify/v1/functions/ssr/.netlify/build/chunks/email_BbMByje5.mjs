...
const ADMIN_EMAIL = "admin@atlasandyou.es";
...
function adminNewOrderHtml(order) {
  return `
    ...
    <p><a href="${"http://localhost:4321"}/admin/pedidos/${order.id}">Ver pedido en el panel</a></p>
  `;
}
...
export { sendLowStockAlert as a, sendOrderConfirmation as b, sendAdminNewOrder as c, sendShippingNotification as s };
